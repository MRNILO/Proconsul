...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Configuración Precio contratos</h2>
    <a href="<%:ViewBag.Ruta_app%>Administrativo/NuevoContrato" class="btn btn-lg blue">Nuevo Contrato +</a>
    <br />
    <br />
    <br />

    <%Response.Write(ViewBag.TablaContrataos) %>
</asp:Content>
...
<asp:Content runat="server" ID="Content3" ContentPlaceHolderID="JavaScriptContent">
    ...
    <script>
        ...
        function estado(idContrato, activo) {
            if (confirm('¿Esta seguro que desea cambiar el estatus de este contrato?')) {
                // Save it!

                $.ajax({
                    type: "POST",
                    url: '<%:Url.Action("CambiaEstadusContrato", "Administrativo")%>',
                    //dataType: "json",
                    data: { id_contrato: idContrato, Estatus: activo }
                })
                    .done(function (msg) {
