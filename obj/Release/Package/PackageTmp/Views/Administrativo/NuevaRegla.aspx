...
<h2>Nueva Regla <%:ViewBag.Mensaje%></h2>
    <%--(ByVal empleado As Integer, ByVal id_clasificacion As Integer, ByVal etapaFinal As Integer, ByVal Cantidad_PagoUnitario As Integer)--%>
  <%Response.Write(ViewBag.Formulario)%>
