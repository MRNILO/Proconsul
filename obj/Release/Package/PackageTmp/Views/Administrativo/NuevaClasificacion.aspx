...
<h2>Agregar una clasificación Nueva <%:ViewBag.Mensaje %></h2>
    <br />
    <form method="post">
        Ingrese una descripción para la nueva clasificación
        <br />
        <input type="text" name="desc_clasificacion" required="required"  class="form-control" />
        <br />
        <input type="submit" value="Guardar"  class="btn btn-lg green"/>
    </form>
