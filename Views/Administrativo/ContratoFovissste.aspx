...
<h2>Contrato Fovissste</h2>
    <br />
    <strong>Ingrese un numero de cliente</strong>
    <form method="post">
        <input type="text" name="numcte"  class="form-control"/>
        <br />
        <br />
        <input type="submit" class="btn btn-lg green"  value="Generar"/>
    </form>
</asp:Content>
