...
<h2>Cancelaciones</h2>
    ...
    <h3>Ingrese parte del nombre del cliente:</h3>
  <form method="post" >
  <input type="text" id="typeahead_example_3" name="numcte" class="form-control" required="required"/>
    <br />
     <%-- <h3>Ingrese la cantidad a penalizar al cliente.</h3>    
      <input type="number" name="PCliente" class="form-control" required="required" min="0" />
      <br />--%>
    <input type="submit" class="btn btn-lg red" value="Cancelar Cliente"/>
      </form>
    <br />
    
    <div style="display:<%:ViewBag.Visibilidad%>">
    <a href="<%:ViewBag.URLExcel%>" class="btn btn-lg green">Formato devolución contabilidad</a>
        </div>
</asp:Content>
