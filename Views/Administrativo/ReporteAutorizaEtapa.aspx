...
<h2>Reporte Etapas autorización</h2>
     <form method="post">
        Seleccione una fecha de inicio:
        <br />
        <input type="date" required="required" name="FechaInicio" id="FechaInicio" class="form-control" />      
        <br />
         Seleccione una fecha final:
        <br />
        <input type="date" required="required" name="FechaFinal" id="FechaFinal" class="form-control" />
         <br />
         Ingrese una etapa:
         <br />
         <input type="number" required="required" name="etapa" class="form-control" />
         <br />
         ¿Incluir Cancelados? <input type="checkbox" name="Cancelados" checked="checked" class="form-control" />
        <br />       
